...
(function () {
  ...
  /**
   * Scroll Spy – update active nav item on manual scroll
   */
  /**
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateActiveNav() {
      ...
      // Remove active only from hash links, not page links
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const SHOW_AFTER = 80; // px from top (adjust if needed)

    function toggleSiteName() {
      if (window.scrollY > SHOW_AFTER) {
        siteName.classList.add("visible");
      } else {
        siteName.classList.remove("visible");
      }
    }
